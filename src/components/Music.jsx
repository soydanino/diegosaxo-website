...
const Music = () => {
  useEffect(() => {
    ...
    const elements = document.querySelectorAll('#music .scroll-reveal');
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="scroll-reveal spotify-card-hover bg-surface-container-low p-6 border-t-2 border-primary-container shadow-2xl">
          <div className="mb-6 aspect-square overflow-hidden bg-surface-container-high relative group">
            <img className="w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-500" data-alt="Close-up artistic shot of a golden saxophone with warm dramatic lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBaBk_-idMFSi2iqXIqtEbu6eOD6FD_BqChdgmwQu4lxP78Wt0Esm_ODEuqpEGzeW-uZCQ-H4-wp_MgECrydE8I62cXEAGagClm0wQTrkPl6hfvNwG-xAGUOO76C4Hwcb4HuWifkGs3_W9UZ2prSt9tmjWOwELUitSvFiTUTEetTljYp_Zkn-2k17JWD9AMjfkkCn6hIPSbOsboklLqfpgmHxI7rluP61KWv8dpPbXVfaLejDhxEW6HWQ" />
        ...
        <div className="scroll-reveal spotify-card-hover bg-surface-container-low p-6 border-t-2 border-primary-container shadow-2xl">
          <div className="mb-6 aspect-square overflow-hidden bg-surface-container-high relative group">
            <img className="w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-500" data-alt="A portrait of a male saxophonist" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCSqqa0ATJTf66poBvPHlonZTlzObYMqo_2YEeXod-0AcC543nhcVMX2Y9R4edbtcqD6H_ylG2dJWBo4XobFyCCcHXMnr0j_NI6uRSfIgdFNQJwu6R_oFnSx4hNhFajpbPGtqC-fkTF1xliHzfmhCgVPjBTOpWelnaG1SUuAOKFCSX57UatzdN9Ka0QWnGgJZbgGdQFB94CxBoojpXAr5ZeDVNlZ-v0K3FxNnG4j-NcqJgz-xK6T_CBBw" />
            <div className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity">
              <span className="material-symbols-outlined text-primary text-5xl" style={{fontVariationSettings: "'FILL' 1"}}>play_circle</span>
            </div>
          </div>
